...
import com.friendfill.foodifie.adapter.HomePagerAdapter;
...
public class HomeFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("Fragment Life", "Fragment Home On Create");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.d("Fragment Life", "Fragment Home On Create View");
        View view = inflater.inflate(R.layout.fragment_home, container, false);
        mListener.SetTitleBarTitle(getResources().getString(R.string.app_name));
        mListener.SetNavigationItem(R.id.menu_item_home);
        ButterKnife.bind(this, view);
        pagerAdapter = new HomePagerAdapter(getChildFragmentManager(), 4);
        home_fragment_pager.setAdapter(pagerAdapter);
        mListener.SetTitleBarTitle(getResources().getString(R.string.app_name));
        categories = new ArrayList<>();
        /*ApplicationConfig.initHomeCategory();
        categories = ApplicationConfig.home_categories;*/
        Category();
        return view;
    }
    ...
    public void onAttach(Context context) {
        Log.d("Fragment Life", "Fragment Home On Attach");
    ...
    public void onDetach() {
        super.onDetach();
        Log.d("Fragment Life", "Fragment Home On Detach");
        mListener = null;
    }
