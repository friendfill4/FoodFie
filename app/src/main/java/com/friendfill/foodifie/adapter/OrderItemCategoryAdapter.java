...
public class OrderItemCategoryAdapter extends RecyclerView.Adapter<OrderItemCategoryAdapter.CategoryViewHolder> {
    ArrayList<Category> categories;
    Context context;
    RecyclerView.RecycledViewPool viewPool;
    int type;

    public OrderItemCategoryAdapter(Context context, ArrayList<Category> categories, int type) {
    ...
    public CategoryViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.single_order_category_view, parent, false);
    ...
    public void onBindViewHolder(CategoryViewHolder holder, final int position) {
        ...
        holder.item_recyclerview.setLayoutManager(new StaggeredGridLayoutManager(1, LinearLayoutManager.VERTICAL));
        OrderItemAdapter itemAdapter = new OrderItemAdapter(this.context, categories.get(position).getItems(), holder.type);
